...
namespace Room_Services.Migrations
{
    /// <inheritdoc />
    public partial class firstmigAdded11TBL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Offer_Price = table.Column<long>(type: "bigint", nullable: false),
                    Offer_Status_Done = table.Column<bool>(type: "bit", nullable: false),
                    Offer_Status_Submited = table.Column<bool>(type: "bit", nullable: false),
                    Offer_Status_Accepted = table.Column<bool>(type: "bit", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tipical_Price = table.Column<long>(type: "bigint", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
